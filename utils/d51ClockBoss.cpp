...
D51ClockBoss* D51ClockBoss::instance = 0;

D51ClockBoss* D51ClockBoss::getInstance(void){
    if(instance == 0){
        instance = new D51ClockBoss();
    }
    return instance;
}

D51ClockBoss* d51ClockBoss = D51ClockBoss::getInstance();

D51ClockBoss::D51ClockBoss(){}

void D51ClockBoss::setup_16mhz_xtal(void){
...
void D51ClockBoss::start_ticker_a(uint32_t us){
    setup_16mhz_xtal();
    // ok
...
void D51ClockBoss::start_ticker_b(uint32_t us){
    setup_16mhz_xtal();
    // ok
